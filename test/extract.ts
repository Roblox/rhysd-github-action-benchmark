...
describe('extractResult()', function() {
    ...
    const normalCases: Array<{
        ...
        {
            tool: 'roblox',
            file: 'roblox_ops_per_sec.txt',
            expected: [
                {
                    type: 'roblox',
                    name: 'fib(10)',
                    range: '±0.74%',
                    unit: RobloxUnit.OPERATIONS_PER_SECOND,
                    value: 1431759,
        ...
        {
            tool: 'roblox',
            file: 'roblox_ms_per_op.txt',
            expected: [
                {
                    type: 'roblox',
                    name: 'fib(10)',
                    range: '±0.74%',
                    unit: RobloxUnit.MS_PER_OPERATION,
                    value: 1431759,
                    extra: '93 samples\nroblox-cli version: 123.456',
                },
                {
