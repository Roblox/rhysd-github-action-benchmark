...
function extractJmhResult(output: string): OtherBenchmarkResult[] {
...
function extractBenchmarkDotnetResult(output: string): OtherBenchmarkResult[] {
...
function extractLuauBenchmarkResult(output: string): OtherBenchmarkResult[] {
    const lines = output.split(/\n/);
    const results: OtherBenchmarkResult[] = [];
